...
export default function LinksSection({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Link
        className="whitespace-nowrap hover:cursor-pointer p-1.5 text-xs md:text-sm md:px-3  font-medium border-2 border-blue-700 rounded-lg text-blue-700 bg-white hover:bg-blue-100"
